...
const addpowderToHTML = () => {
    let powderForm = document.querySelector('form[name="size"]');
    powderForm.innerHTML = ''; // Clear existing options
            ...
            newProduct.innerHTML =
                ...
                <form method="post" name="addon">
                    ...
                    <select name="addon">
                        ...
                        <option value="หอมทอด">หอมทอด</option>
                        <option value="เฟรนฟราย">เฟรนฟราย</option>
                        <option value="กิมจิ">กิมจิ</option>
                        <option value="ไชเท้าดอง">ไชเท้าดอง</option>
                    </select>
                </form>
                ...
                <form method="post" name="toppings">
                    ...
                    <select name="toppings">
                        <option value="none">ไม่ใส่ผง</option>
                        <option value="cheese">ชีส</option>
                        <option value="corn">ข้าวโพด</option>
                        <option value="hotandspicy">ฮอตแอนด์สไปซี่</option>
                        <option value="pizza">พิซซ่า</option>
                        <option value="paprika">ปาปริก้า</option>
                    </select>
                </form>
...
const addCartToHTML = () => {
    ...
    const addonPriceDisplay = document.getElementById('addonPriceDisplayValue');
    addonPriceDisplay.textContent = totalPrice.toFixed(2);
